  ...
  render() {
    ...
    const slides = items.map(item => {
      return (
        ...
        >
          ...
          <div className="swiper-pic" style={{ backgroundImage: 'url(' + item.src + ')' }}></div>
    ...
    return (
      <div className="swiper">
        ...
        >
          <CarouselIndicators items={items} activeIndex={activeIndex} onClickHandler={this.goToIndex.bind(this)} />
          {slides}
